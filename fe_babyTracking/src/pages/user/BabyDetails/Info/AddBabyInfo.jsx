...
const AddBabyInfo = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        console.log("Submitted Data:", babyData);
        ...
        <>
            <div>
                ...
                <div className="flex justify-between items-center mb-8">
                    ...
                    <h2 className="text-2xl font-bold text-purple-800 text-center">Thêm chỉ số cho bé</h2>
                    <a href="#" className="text-purple-600 text-lg hover:underline">Tất cả chỉ số</a>
                </div>
            ...
            <div className="max-w-4xl mx-auto p-8 bg-white shadow-lg rounded-lg">
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-6">
                    ...
                    {/* Cân nặng */}
                    <div>
                        <label className="block text-purple-700 font-medium mb-2">Cân nặng</label>
                        <div className="flex items-center border rounded-lg overflow-hidden">
                            ...
                            />
                            <span className="bg-gray-100 px-5 py-4 text-gray-700 text-lg">kg</span>
                        </div>
                    </div>

                    {/* Chiều cao */}
                    <div>
                        <label className="block text-purple-700 font-medium mb-2">Chiều cao</label>
                        <div className="flex items-center border rounded-lg overflow-hidden">
                            <input
                                type="number"
                                name="height"
                                ...
                                className="w-full p-4 outline-none text-lg"
                            />
                            <span className="bg-gray-100 px-5 py-4 text-gray-700 text-lg">cm</span>
                        </div>
                    </div>

                    {/* Chu vi đầu */}
                    <div>
                        <label className="block text-purple-700 font-medium mb-2">Chu vi đầu</label>
                        <div className="flex items-center border rounded-lg overflow-hidden">
                            <input
                                type="number"
                    ...
                    {/* Ngày */}
                    <div>
                        <label className="block text-purple-700 font-medium mb-2">Ngày</label>
