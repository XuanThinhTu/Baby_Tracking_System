      ...
      <div className="grid grid-cols-12 gap-10">
        ...
        <aside className="col-span-4 bg-white shadow-lg rounded-lg p-6">
          <div className="text-center">
            ...
            />
            <h2 className="text-3xl font-semibold text-gray-800 mt-4">{baby?.name}</h2>
            <p className="text-gray-500 text-lg mt-1">
              Ngày sinh: {dayjs(baby?.birthDate).format("DD/MM/YYYY")}
            </p>
            <p className="text-gray-600 text-md">Tuổi: {calculateAge(baby?.birthDate)} tuổi</p>
            <p className="text-gray-600 text-md">Tuần: {calculateTotalWeeks(baby?.birthDate)} tuần tuổi</p>
          </div>
        </aside>
        ...
        <section className="col-span-8">
          <div className="bg-white shadow-lg rounded-lg p-6">
            <h3 className="text-2xl font-medium text-gray-700 mb-4">Chỉ số sức khỏe</h3>
            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="flex flex-col items-center bg-gray-100 rounded-lg p-4">
                ...
                <p className="text-xl font-semibold mt-2">{baby?.height || "N/A"}</p>
                <p className="text-gray-500 text-md">Chiều cao</p>
              </div>
              <div className="flex flex-col items-center bg-gray-100 rounded-lg p-4">
                <FaWeight className="text-green-500 text-5xl" />
                <p className="text-xl font-semibold mt-2">{baby?.weight || "N/A"}</p>
          ...
          {/* Features Section */}
          <div className="mt-6">
            <h3 className="text-2xl font-medium text-gray-700">Tính năng theo dõi</h3>
